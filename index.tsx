    ...
    <View style={styles.container} >
      ...
      <View style = {styles.containerConteudo}>
        <View style = {styles.containerNome}>
          <Text style={styles.nome}>carlos Gabriel Cardoso pereira </Text>
        </View>
        ...
        <View style = {styles.containerDados}>
          ...
          <Text style = {styles.textoDados}>cardoso.pereira.carlos@escola.pr.gov.br</Text>
        </View>
        <View style = {styles.containerDados}>
          <Ionicons name="call" size={24} color="white" />
          <Text style = {styles.textoDados}>(42) 99333-4645</Text>
        </View>
        <View style = {styles.containerDados}>
